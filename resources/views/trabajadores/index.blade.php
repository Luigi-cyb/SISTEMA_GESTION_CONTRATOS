            ...
            <div class="p-6">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">Total de registros: <span class="font-medium">{{ $trabajadores->total() }}</span></p>
                    </div>
                        ...
                        <div class="md:col-span-3">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" 
                                       ...
                                       id="search"
                                       value="{{ $search }}" 
                                       placeholder="Ingrese DNI, nombre, cargo o área..."
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex justify-end space-x-3">
                                    ...
                                    <form action="{{ route('trabajadores.destroy', $trabajador->dni) }}" 
                                          method="POST" 
                                          class="inline-block"
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                ...
                                <p class="mt-1 text-sm text-gray-500">Comience creando un nuevo trabajador.</p>
                                @can('create.trabajadores')
                                <div class="mt-6">
                                    <a href="{{ route('trabajadores.create') }}" 
