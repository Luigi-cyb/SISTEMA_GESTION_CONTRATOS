        ...
        <div class="bg-white shadow-sm sm:rounded-lg mb-6">
            <div class="p-6">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-2xl font-semibold text-gray-900">Adendas de Contratos</h1>
                        <p class="text-sm text-gray-600 mt-1">Total de registros: <span class="font-medium">{{ $adendas->total() }}</span></p>
                    </div>
                    @can('create.adendas')
                    <a href="{{ route('adendas.create') }}" 
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">{{ $adenda->trabajador->nombre_completo }}</div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex justify-end space-x-3">
                                    ...
                                    @endcan
                                    @can('delete.adendas')
                                    <form action="{{ route('adendas.destroy', $adenda->id) }}" 
                                          method="POST" 
                                          class="inline-block"
