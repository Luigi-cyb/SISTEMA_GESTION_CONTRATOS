...
<div class="clausula-contenido">
    ...
    @endif
        ...
        <div class="clausula-contenido">
            <strong>LA EMPRESA</strong> ha celebrado un Contrato de Tercerización de "SERVICIO DE MANEJO DE RESIDUOS SÓLIDOS" CHUNGAR - HUAYLLAY en adelante denominado Contrato Principal, con la COMPAÑÍA MINERA CHUNGAR SAC., con el objeto de ejecutar los "SERVICIO DE MANEJO DE RESIDUOS SÓLIDOS" CHUNGAR - HUAYLLAY, de la cual es titular, y que se encuentra ubicada en el Distrito de Huayllay, Provincia Pasco, Departamento Pasco.
        </div>

        <div class="clausula-contenido">
            Conforme a lo establecido en el Contrato Principal, la obra denomina Unidad Chungar es donde se ejecutarán labores de "SERVICIO DE MANEJO DE RESIDUOS SÓLIDOS" CHUNGAR - HUAYLLAY, servicios contratados con <strong>LA EMPRESA</strong> por COMPAÑÍA MINERA CHUNGAR SAC., se vienen ejecutando y continuarán ejecutándose en el Centro de Operaciones de COMPAÑÍA MINERA CHUNGAR SAC, UEA Chungar, ubicada en el Distrito de Huayllay, Provincia Pasco, Departamento Pasco.
        </div>
...
<div class="page-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="clausula-titulo">CLÁUSULA VIGÉSIMO PRIMERO. - DOMICILIO DE LAS PARTES</div>
        <div class="clausula-contenido">
