...
// Función para calcular la duración entre dos fechas (SIN REDONDEO)
...
<div class="page-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="titulo-contrato">CONTRATO DE TRABAJO SUJETO A MODALIDAD POR INCREMENTO DE ACTIVIDAD</div>
        
        <div class="texto-introductorio">
            Conste por el presente documento, el Contrato de Trabajo Sujeto a Modalidad para Incremento de Actividad, que celebran de conformidad con el Artículo 57° del Texto Único Ordenado (TUO) del Decreto Legislativo N° 728, Ley de Productividad y Competitividad Laboral (LPCL), aprobado por Decreto Supremo N° 003-97-TR, de una parte, <strong>{{ $configuracion->razon_social }}</strong> con <strong>RUC Nº {{ $configuracion->ruc }}</strong>, y domicilio en <strong>{{ $configuracion->direccion }}</strong>, debidamente representada por su Gerente General <strong>{{ $configuracion->gerenteNombreCompleto() }}</strong> con D.N.I N° <strong>{{ $configuracion->gerente_dni }}</strong>, a quien en adelante se le denominará <strong>LA EMPRESA</strong>; y de otra parte Don (ña) <strong>{{ $trabajador->nombre_completo ?? 'APELLIDOS_Y_NOMBRES' }}</strong>, identificado con D.N.I. N° <strong>{{ $trabajador->dni ?? 'N_DNI' }}</strong>, domiciliado en <strong>{{ $trabajador->direccion_actual ?? 'DIRECCIÓN' }}</strong>, a quien en lo sucesivo se le denominará <strong>EL TRABAJADOR</strong>; en los términos y condiciones siguientes:
        </div>

        <div class="clausula-titulo">CLAUSULA PRIMERA. – ANTECEDENTES DE LA EMPRESA</div>
        <div class="clausula-contenido">
            <strong>LA EMPRESA</strong> es una persona jurídica cuyo objeto social es prestar servicios de diversa índole, dedicada a brindar un servicio integral en minería superficial y subterránea tales como: obras civiles, gestión ambiental, transporte y servicios generales, de acuerdo a la necesidad de nuestros clientes, Asimismo.
        </div>

        <div class="clausula-contenido">
            <strong>LA EMPRESA</strong> ha iniciado una nueva actividad relacionado a la fabricación de bloques de concreto para construcción y que se encuentra ubicada en el C.P. de Canchacucho, en el Distrito de Huaylllay, Provincia y Departamento de Pasco
        </div>

        <div class="clausula-titulo">CLAUSULA SEGUNDA. – CAUSA OBJETIVA Y NATURALEZA DE CONTRATACIÓN</div>
        <div class="clausula-contenido">
            Por el presente contrato y de conformidad con lo dispuesto por el artículo 57 del Texto Único Ordenado del Decreto Legislativo N° 728, Ley de Productividad y Competitividad Laboral, aprobado por el Decreto Supremo N° 003-97-TR, <strong>EL EMPLEADOR</strong> contrata a <strong>EL TRABAJADOR</strong> bajo la modalidad de Contrato de Incremento de Actividad, a fin de que desarrolle las labores de <strong>{{ $trabajador->cargo ?? 'CARGO' }}</strong>.
        </div>
        ...
        <div class="clausula-contenido">
            <strong>EL TRABAJADOR</strong> desempeñará sus labores en el cargo de <strong>"{{ $trabajador->cargo ?? 'CARGO' }}"</strong>, desarrollando las labores referente a dicho cargo; sin embargo <strong>LA EMPRESA</strong> está facultado a efectuar modificaciones razonables en función a la capacidad y aptitud de <strong>EL TRABAJADOR</strong>, sin que dichas variaciones signifiquen menoscabo de remuneración, en ejercicio de sus facultades de dirección y administración de sus recursos humanos y materiales que legalmente le corresponden, pudiendo incluso disponer que <strong>EL TRABAJADOR</strong> desempeñe otras labores en adición o en sustitución de las originalmente asignadas, siempre que resulten compatibles con la naturaleza del presente contrato.
        </div>

        <div class="clausula-contenido">
            Queda entendido que la prestación de servicios deberá ser efectuada de manera personal, no pudiendo <strong>EL TRABAJADOR</strong> ser reemplazado ni ayudado por tercera persona.
        </div>
    </div>
</div>
...
<div class="page-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="clausula-contenido">
            El inicio del acuerdo contractual es: <strong><?php echo $fechaInicioFormateada; ?></strong>. El plazo de Vigencia del presente contrato entre <strong>EL TRABAJADOR</strong> y <strong>LA EMPRESA</strong> es por el periodo de <strong>(<?php echo $duracionContrato; ?>)</strong> del <strong><?php echo $fechaInicioFormateada; ?></strong> al <strong><?php echo $fechaFinFormateada; ?></strong>, en el que concluye la prestación de servicios, sin necesidad de aviso previo entre las partes. A la conclusión del contrato <strong>LA EMPRESA</strong> abonará a <strong>EL TRABAJADOR</strong>, los beneficios sociales que pudieran corresponderle de acuerdo a la legislación laboral vigente.
        </div>
        ...
        <div class="clausula-titulo">CLAUSULA SEPTIMA. - RETRIBUCIÓN</div>
<div class="clausula-contenido">
    ...
    @endif
        ...
        <div class="clausula-contenido">
            Las ausencias injustificadas por parte de <strong>EL TRABAJADOR</strong> implicarán la pérdida de la remuneración de manera proporcional a la duración de dicha ausencia, sin perjuicio del ejercicio de las facultades
        </div>
    </div>
</div>
...
<div class="page-wrapper">
    ...
    <div class="page-content">
         <div class="clausula-contenido">
         disciplinarias que <strong>LA EMPRESA</strong> podrá ejecutar de conformidad con la legislación laboral vigente y las normas internas de <strong>LA EMPRESA</strong>.
        </div>
...
<div class="clausula-contenido">
            Hoja de liquidación de beneficios sociales incluyendo; Compensación por tiempo de servicio trunca (CTS), vacaciones truncas y gratificaciones truncas (el trabajador se encuentra obligado a acercarse a recabar dicho documento).
        </div>
...
<div class="page-wrapper">
    <img src="data:image/jpeg;base64,{{ $bgData }}" class="page-bg">
    <div class="page-content">
        <div class="clausula-titulo">CLAUSULA DECIMA TERCERA. - SOBRE LAS ENFERMEDADES PROFESIONALES</div>
        <div class="clausula-contenido">
        ...
        <div class="clausula-contenido">
            Sin perjuicio de lo antes expuesto, <strong>EL TRABAJADOR</strong> reconoce que la pensión que le pudiera corresponder en virtud del seguro complementario de trabajo de riesgo como consecuencia de cualquier enfermedad profesional y/o accidente de trabajo que pudiera tener su origen en la relación laboral con <strong>LA EMPRESA</strong>, sustituyo y/o compensa en su integridad cualquier monto que se pudiera demandar vía acción de indemnización por daños y perjuicios por responsabilidad contractual o extracontractual, incluyendo el lucro cesante, el daño emergente y/o el daño moral. Por otro lado, en la presente clausula, <strong>LA EMPRESA</strong> se encuentra obligada a proporcionar los implementos de Seguridad a <strong>EL TRABAJADOR</strong> con la finalidad de reducir los riesgos de contraer enfermedad profesional. En caso que <strong>LA EMPRESA</strong> no cumpla con proporcionar dichos implementos de seguridad o los que proporcione no sean suficientes, <strong>EL TRABAJADOR</strong> se obliga a presentar una queja escrita ante su Supervisor o a su elección una queja ante la Autoridad de Trabajo, en el plazo de 24 horas de ocurrido el hecho. En caso no presentar dicha queja, se entiende que <strong>EL TRABAJADOR</strong> ha recibido a su satisfacción y de acuerdo con los dispositivos legales vigentes para el tipo de actividad que desarrolla.
        </div>

        <div class="clausula-titulo">CLAUSULA DECIMA CUARTA. - CONDICIONES DE TRABAJO</div>
        <div class="clausula-contenido">
            Para el cabal cumplimiento de sus obligaciones laborales, <strong>EL EMPLEADOR</strong> determinara los implementos, sistemas, equipos, materiales, herramientas y demás condiciones de trabajo que considere sean requeridos para el cabal desempeño de las labores encomendadas a <strong>EL TRABAJADOR</strong>. Por su parte, <strong>EL TRABAJADOR</strong> reconoce expresamente que le está terminantemente prohibido emplear dichos elementos de trabajo para fines personales o ajenos al cumplimiento del presente contrato de trabajo. El incumplimiento de esta prohibición por parte de <strong>EL TRABAJADOR</strong> facultara a <strong>EL EMPLEADOR</strong> a adoptar las medidas disciplinarias que resulten pertinentes. Al momento de producirse el cese de <strong>EL TRABAJADOR</strong>, sea por cualquier causa, se encontrará obligado a devolver a <strong>EL EMPLEADOR</strong> todos los implementos, sistemas, equipos, fotocheck, materiales, herramientas y demás condiciones de trabajo otorgados por este para el debido cumplimiento de las obligaciones laborales.
        </div>

        <div class="clausula-titulo">CLÁUSULA DÉCIMA QUINTA. – SUSPENSIÓN DEL CONTRATO</div>
        <div class="clausula-contenido">
...
<div class="page-wrapper">
    ...
    <div class="clausula-titulo">CLAUSULA DECIMO SEXTA. - CAUSAS DE EXTINCION</div>
        <div class="clausula-contenido">
        ...
        <div class="clausula-titulo">CLAUSULA DECIMO SEPTIMA. - TERMINO DEL CONTRATO</div>
        <div class="clausula-contenido">
        ...
        <div class="clausula-titulo">CLAUSALA DECIMO OCTAVA. -  NORMAS APLICABLES</div>
        <div class="clausula-contenido">
            Las partes dejan expresa constancia que el presente Contrato se celebra al amparo de lo establecido en el art. 57° de la LPCL, que regula el Contrato de Trabajo Sujeto a Modalidad por Incremento de Actividad, así como en virtud a lo establecido por Ley N° 29245, Ley que Regula los Servicios de Tercerización, y el Decreto Supremo N° 006-2008-TR, Reglamento de la Ley que regula los Servicios de Tercerización.
        </div>

        <div class="clausula-titulo">CLAUSULA DECIMO NOVENA. - DE LA VALIDEZ DEL CONTRATO</div>
        <div class="clausula-contenido">
        ...
        <div class="clausula-titulo">CLÁUSULA VIGESIMA. – JURISDICCIÓN</div>
        <div class="clausula-contenido">
...
<div class="page-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="clausula-titulo">CLÁUSULA VIGESIMA PRIMERA. - DOMICILIO DE LAS PARTES</div>
        <div class="clausula-contenido">
