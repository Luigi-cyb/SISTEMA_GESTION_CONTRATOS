...
<div class="page-wrapper">
    ...
    <div class="clausula-contenido">
 puede ser modificado de acuerdo a las necesidades de la empresa. El control de los periodos de trabajo, de descanso y horario de trabajo, estará a cargo de LA EMPRESA, la cual entregará al TRABAJADOR una tarjeta de tarea diario y una papeleta de movimiento de personal para su periodo de descanso para su control.
        </div>
...
Las ausencias injustificadas por parte de EL TRABAJADOR implicarán la pérdida de la remuneración de manera proporcional a la duración de dicha ausencia, sin perjuicio del ejercicio de las facultades disciplinarias que LA EMPRESA podrá ejecutar de conformidad con la legislación laboral vigente y las normas internas de LA EMPRESA.
        ...
        <div class="clausula-contenido">
De conformidad con los Artículos 4° y 6° de la Ley N° 29245, Ley que Regula los Servicios de Tercerización, así como de conformidad con el Artículo 8° del Decreto Supremo N° 006-2008-TR, Reglamento de la Ley que regulan los Servicios de Tercerización, LA EMPRESA brindara la información de la Empresa Principal, siempre en cuando el TRABAJOR lo solicite.
        </div>

        <div class="clausula-titulo">ACTIVIDADES A EJECUTARSE CONFORME AL OBJETO DEL CONTRATO PRINCIPAL</div>
        <div class="clausula-contenido">
LA EMPRESA ha celebrado un Contrato de Tercerización de "SERVICIO DE OBRAS CIVILES, REMODELACIONES, CARPINTERÍA, MANEJO DE RESIDUOS RELACIONADOS AL MEDIO AMBIENTE Y SERVICIO DE REFORESTACIÓN EN ZONAS CIRCULANTES A LA UNIDAD DE PRODUCCIÓN." CHUNGAR – HUAYLLAY en adelante denominado Contrato Principal, con la COMPAÑÍA MINERA CHUNGAR SAC., con el objeto de ejecutar los "SERVICIO DE OBRAS CIVILES, REMODELACIONES, CARPINTERÍA, MANEJO DE RESIDUOS RELACIONADOS AL MEDIO AMBIENTE Y SERVICIO DE REFORESTACIÓN EN ZONAS CIRCULANTES A LA UNIDAD DE PRODUCCIÓN." CHUNGAR – HUAYLLAY, en la Unidad Chungar, de la cual es titular, y que se encuentra ubicada en el Distrito de Huayllay, Provincia Pasco, Departamento Pasco.
        </div>

        <div class="clausula-contenido">
Conforme a lo establecido en el Contrato Principal, la obra denomina Unidad Chungar es donde se ejecutarán labores de "SERVICIO DE OBRAS CIVILES, REMODELACIONES, CARPINTERIA, MANEJO DE RESIDUOS RELACIONADOS AL MEDIO AMBIENTE Y SERVICIO DE REFORESTACION EN ZONAS CIRCULANTES A LA UNIDAD DE PRODUCCION." CHUNGAR - HUAYLLAY, servicios contratados con LA EMPRESA por COMPAÑÍA MINERA CHUNGAR SAC., se vienen ejecutando y continuarán ejecutándose en el Centro de Operaciones de COMPAÑÍA MINERA CHUNGAR SAC, UEA Chungar, ubicada en el Distrito de Huayllay, Provincia Pasco, Departamento Pasco.
        </div>
...
LA EMPRESA no estará obligada a otorgar PRE. AVISO alguno a EL TRABAJADOR para efectos de la terminación del presente contrato, operando su extinción de modo automático al vencimiento del plazo convenido en la cláusula cuarta precedente (terminación del contrato y/o de su renovación por conclusión natural de su plazo de duración).
        ...
        <div class="clausula-titulo">CLÁUSULA DÉCIMA OCTAVA. - NORMAS APLICABLES</div>
        <div class="clausula-contenido">
...
<div class="page-wrapper">
    ...
    <div class="clausula-titulo">CLÁUSULA VIGÉSIMA – JURISDICCIÓN</div>
        <div class="clausula-contenido">
Ambas partes renuncian expresamente al fuero de sus respectivos domicilios y se someten, para todos los efectos relativos a la validez, interpretación y/o ejecución de los términos del presente Contrato, a los Juzgados y Salas Laborales de Pasco.
        ...
        <div class="clausula-titulo">CLÁUSULA VIGÉSIMA PRIMERA.- DOMICILIO DE LAS PARTES</div>
        <div class="clausula-contenido">
