...
En tal virtud el presente Contrato se celebra de conformidad con los artículos 53°,54°,57 y siguientes del Texto Único Ordenado del Decreto Legislativo N° 728, aprobado por Decreto Supremo N° 003-97-TR, Ley de Productividad y Competitividad Laboral (en adelante) LA LEY.
        ...
        <div class="clausula-contenido">
En razón de la causa objetiva señalada en la Cláusula Segunda, por el presente documento LA EMPRESA contrata a plazo determinado bajo la modalidad de Servicio Específico para que EL TRABAJADOR realice las labores de <strong>"{{ $trabajador->cargo ?? 'OBJETO_CARGO' }}"</strong>, según perfil de puesto. Se deja constancia que EL TRABAJADOR cumplirá las labores materia del presente Contrato en el Centro de 
        </div>
...
<div class="page-wrapper">
    ...
    <div class="clausula-contenido">
Operaciones de la Empresa Principal, concretamente en el Centro de Operaciones de la Empresa Principal, concretamente en la Unidad Huarón, ubicada en el Distrito de Huayllay, Provincia de Pasco, Dpto. de Pasco.
        </div>
        
        <div class="clausula-contenido">
Tratándose de un Contrato de Trabajo sujeto a Modalidad por Servicio Específico, se deja constancia que el presente está sujeto a la temporalidad y contingencias que deriven de la ejecución de de "SERVICIO DE LIMPIEZA EN PLANTA CONCENTRADORA" Para los cuales LA EMPRESA fue contratada en virtud a la Orden de Servicio suscrito con PAN AMERICAN SILVER HUARON S.A., situación que EL TRABAJADOR declara conocer plenamente, aceptando a través de la suscripción del presente cualquier cambio que se produzca en la relación contractual entre LA EMPRESA PAN AMERICAN SILVER HUARON S.A. (Empresa Principal), y que incida en la relación laboral que por este acto se formaliza entre LA EMPRESA y EL TRABAJADOR.
        </div>
...
Las ausencias injustificadas por parte de EL TRABAJADOR implicarán la pérdida de la remuneración de manera proporcional a la duración de dicha ausencia, sin perjuicio del ejercicio de las facultades disciplinarias que LA EMPRESA podrá ejecutar de conformidad con la legislación laboral vigente y las normas internas de LA EMPRESA.
        ...
        <div class="clausula-titulo">CLAUSULA SEPTIMA. - INFORMACIÓN DE LA EMPRESA PRINCIPAL</div>
        <div class="clausula-contenido">
De conformidad con los Artículos 4° y 6° de la Ley N° 29245, Ley que Regula los Servicios de Tercerización, así como de conformidad con el Artículo 8° del Decreto Supremo N° 006-2008-TR, Reglamento de la Ley que regulan los Servicios de Tercerización, LA EMPRESA informara la identidad de la empresa principal siempre y cuando lo solicite.
        </div>

        <div class="clausula-titulo">ACTIVIDADES A EJECUTARSE CONFORME AL OBJETO DE LA ORDEN DE TRABAJO</div>
        <div class="clausula-contenido">
LA EMPRESA ha recibido una Orden de Trabajo de "SERVICIO DE LIMPIEZA EN PLANTA CONCENTRADORA" en adelante denominado Orden de Trabajo, con la PAN AMERICAN SILVER HUARON S.A., con el objeto de ejecutar los "SERVICIO DE LIMPIEZA EN PLANTA CONCENTRADORA" en la Unidad Huarón, de la cual es titular, y que se encuentra ubicada en el Distrito de Huayllay, Provincia Pasco, Departamento Pasco.
        </div>

        <div class="clausula-contenido">
Conforme a lo establecido en la Orden de Trabajo, la obra denomina Unidad Huaron es donde se ejecutarán labores de "SERVICIO DE LIMPIEZA EN PLANTA CONCENTRADORA", servicios contratados con LA EMPRESA por PAN AMERICAN SILVER HUARON S.A., se vienen ejecutando y continuarán ejecutándose en el Centro de Operaciones de PAN AMERICAN SILVER HUARON S.A., UEA Huarón, ubicada en el Distrito de Huayllay, Provincia Pasco, Departamento Pasco.
        </div>

        <div class="clausula-titulo">CLAUSULA OCTAVA. - DEBERES DEL TRABAJADOR</div>
        <div class="clausula-contenido">
EL TRABAJADOR se obliga a cumplir con lealtad y eficiencia sus obligaciones y las funciones propias de su puesto de trabajo, así como las demás que le sean encomendadas. De igual manera, EL TRABAJADOR se compromete a cumplir las órdenes e instrucciones que le imparta LA EMPRESA o sus representantes, así como las normas propias del centro de trabajo y las demás normas que se impartan por necesidades de la obra o del servicio. Asimismo, EL TRABAJADOR se compromete a aplicar en el desempeño de sus labores toda su experiencia y capacidad de trabajo, así como a cumplir con las normas contenidas en el Reglamento Interno de Trabajo de LA EMPRESA, el Reglamento de Seguridad e Higiene Ocupacional, el Reglamento de Seguridad y Salud en el Trabajo, así como también las órdenes, normas y disposiciones que la Empresa cree conveniente del Centro de Trabajo y que imparta LA EMPRESA en ejercicio de las facultades conferidas en el art. 9° de la LPCL.
        </div>
...
<strong>b.</strong> Hoja de liquidación de beneficios sociales incluyendo; Compensación por tiempo de servicio trunca (CTS), vacaciones truncas y gratificaciones truncas (el trabajador se encuentra obligado a acercarse a recabar dicho documento).
        ...
        <div class="clausula-titulo">CLAUSULA DECIMA. - DEL CUMPLIMIENTO DEL CODIGO DE ETICA Y CONFLICTOS DE INTERESES</div>
        <div class="clausula-contenido">
...
<strong>d.</strong> Utilizar el equipo de protección personal EPP para protección de la integridad y salud durante la ejecución de trabajos bajo su responsabilidad.
        ...
        <div class="clausula-titulo">CLAUSULA DECIMA SEGUNDA. - SOBRE LAS ENFERMEDADES PROFESIONALES</div>
        <div class="clausula-contenido">
...
<div class="page-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="clausula-titulo">CLAUSULA DECIMO TERCERA. - CONDICIONES DE TRABAJO</div>
        <div class="clausula-contenido">
Para el cabal cumplimiento de sus obligaciones laborales, LA EMPRESA determinara los implementos, sistemas, equipos, materiales, herramientas y demás condiciones de trabajo que considere sean requeridos para el cabal desempeño de las labores encomendadas a EL TRABAJADOR. Por su parte, EL TRABAJADOR reconoce expresamente que le está terminantemente prohibido emplear dichos elementos de trabajo para fines personales o ajenos al cumplimiento del presente contrato de trabajo. El incumplimiento de esta prohibición por parte de EL TRABAJADOR facultara a LA EMPRESA a adoptar las medidas disciplinarias que resulten pertinentes.
        </div>
...
<div class="clausula-titulo">CLÁUSULA DÉCIMO SEXTA. - CONDICIÓN RESOLUTORIA</div>
        <div class="clausula-contenido">
Atendiendo a que la causa objetiva que justifica la contratación temporal materia del presente es el cumplimiento de "SERVICIO DE LIMPIEZA EN PLANTA CONCENTRADORA" materia de la Orden de servicio suscrito entre LA EMPRESA y PAN AMERICAN SILVER HUARON SA. (Empresa Principal), las partes acuerdan que, de conformidad con lo establecido por el art. 16°, inc. c) de la LPCL, el presente Contrato quedará resuelto y se extinguirá por tanto la relación laboral existente entre LA EMPRESA y EL TRABAJADOR, en caso la Orden de Trabajo antes reseñado sea resuelto y quede sin efecto, situación que EL TRABAJADOR declara conocer con la suscripción del presente.
        </div>
...
LA EMPRESA no estará obligada a otorgar PRE. AVISO alguno a EL TRABAJADOR para efectos de la terminación del presente contrato, operando su extinción de modo automático al vencimiento del plazo convenido en la cláusula cuarta precedente (terminación del contrato y/o de su renovación por conclusión natural de su plazo de duración)
        ...
        <div class="clausula-titulo">CLAUSULA DECIMO OCTAVA. - NORMAS APLICABLES</div>
        <div class="clausula-contenido">
...
Ambas partes renuncian expresamente al fuero de sus respectivos domicilios y se someten, para todos los efectos relativos a la validez, interpretación y/o ejecución de los términos del presente Contrato, a los Juzgados y Salas Laborales de Pasco.
        ...
        <div class="clausula-titulo">CLÁUSULA VIGESIMO PRIMERA. - DOMICILIO DE LAS PARTES</div>
        <div class="clausula-contenido">
