...
<div class="page-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="clausula-contenido">
            En tal virtud el presente Contrato se celebra de conformidad con los artículos 53°,54°,57 y siguientes del Texto Único Ordenado del Decreto Legislativo N° 728, aprobado por Decreto Supremo N° 003-97-TR, Ley de Productividad y Competitividad Laboral (en adelante) <strong>LA LEY</strong>.
        </div>
...
<div class="clausula-contenido">
    ...
    @endif
        ...
        <div class="clausula-contenido">
            <strong>LA EMPRESA</strong> ha celebrado un Contrato de Tercerización de "SERVICIO DE: MANEJO Y OPERACIÓN DE LA PLANTA DE AGUA RESIDUAL INDUSTRIAL, MANEJO Y OPERACIÓN DE LA PLANTA DE AGUA RESIDUAL DOMÉSTICA, MANEJO Y OPERACIÓN DE LA PLANTA DE AGUA POTABLE, ORDEN Y LIMPIEZA DEL ALMACÉN QUIMACOCHA, APILAMIENTO DE RESIDUOS EN TRINCHERA SANITARIA, MONITOREO AMBIENTAL Y TRABAJOS EN CAMPO" CHUNGAR - HUAYLLAY en adelante denominado Contrato Principal, con la COMPAÑÍA MINERA CHUNGAR SAC., con el objeto de ejecutar los "SERVICIO DE: MANEJO Y OPERACIÓN DE LA PLANTA DE AGUA RESIDUAL INDUSTRIAL, MANEJO Y OPERACIÓN DE LA PLANTA DE AGUA RESIDUAL DOMÉSTICA, MANEJO Y OPERACIÓN DE LA PLANTA DE AGUA POTABLE, ORDEN Y LIMPIEZA DEL ALMACÉN QUIMACOCHA, APILAMIENTO DE RESIDUOS EN TRINCHERA SANITARIA, MONITOREO AMBIENTAL Y TRABAJOS EN CAMPO" CHUNGAR - HUAYLLAY, de la cual es titular, y que se encuentra ubicada en el Distrito de Huayllay, Provincia Pasco, Departamento Pasco.
        </div>

        <div class="clausula-contenido">
            Conforme a lo establecido en el Contrato Principal, la obra denomina Unidad Chungar es donde se ejecutarán labores de "SERVICIO DE: MANEJO Y OPERACIÓN DE LA PLANTA DE AGUA RESIDUAL INDUSTRIAL, MANEJO Y OPERACIÓN DE LA PLANTA DE AGUA RESIDUAL DOMÉSTICA, MANEJO Y OPERACIÓN DE LA PLANTA DE AGUA POTABLE, ORDEN Y LIMPIEZA DEL ALMACÉN QUIMACOCHA, 
        </div>
...
<div class="page-wrapper">
    ...
    <div class="page-content">
        <div class="clausula-contenido">
            APILAMIENTO DE RESIDUOS EN TRINCHERA SANITARIA, MONITOREO AMBIENTAL Y TRABAJOS EN CAMPO" CHUNGAR - HUAYLLAY, servicios contratados con <strong>LA EMPRESA</strong> por COMPAÑÍA MINERA CHUNGAR SAC., se vienen ejecutando y continuarán ejecutándose en el Centro de Operaciones de COMPAÑÍA MINERA CHUNGAR SAC, UEA Chungar, ubicada en el Distrito de Huayllay, Provincia Pasco, Departamento Pasco.
        </div>
        ...
        <div class="clausula-contenido">
            Asi mismo <strong>LA EMPRESA</strong> hará entrega los siguientes documentos:
        </div>
...
<div class="page-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="clausula-contenido">
            Al momento de producirse el cese de <strong>EL TRABAJADOR</strong>, sea por cualquier causa, se encontrará obligado a devolver a <strong>LA EMPRESA</strong> todos los implementos de seguridad, sistemas, equipos, fotocheck, materiales, herramientas y demás condiciones de trabajo otorgados por este para el debido cumplimiento de las obligaciones laborales.
        </div>

        <div class="clausula-titulo">CLÁUSULA DÉCIMO CUARTA- SUSPENSIÓN Y EXTINCIÓN DEL CONTRATO</div>
        <div class="clausula-contenido">
            Se deja constancia que la suspensión del presente contrato de trabajo procederá cuando se produzca alguna de las causas previstas en el art. 12° de la LPCL. De igual manera, se deja establecido que la extinción del presente contrato de trabajo procederá en caso de producirse alguna de las causas previstas en el Art. 16° de la LPCL.
        </div>
...
<div class="page-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="clausula-titulo">CLAUSULA DECIMO QUINTA. - CAUSAS DE EXTINCION</div>
        <div class="clausula-contenido">
        ...
        <div class="lista-contenido">
            ...
            <strong>c.</strong> El vencimiento del plazo establecido en la cláusula cuarta del presente contrato.<br>
        ...
        <div class="clausula-contenido">
            Las partes reconocen que el presente contrato es un acto jurídico valido que no implica renuncia de derechos de ningún tipo, razón por la cual se ratifican en cada una de sus cláusulas, por ser esa la voluntad expresa de las partes. Además, <strong>EL TRABAJADOR</strong> deja expresa constancia que en la
        </div>
...
<div class="page-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="clausula-contenido">
             celebración del presente contrato no ha mediado error, dolo, violencia, presión, intimidación, coacción o cualquier vicio que afectase su voluntad, manifestando que actúa libremente y por propia decisión en su calidad de ciudadano en pleno uso de sus facultades.
        </div>

        <div class="clausula-titulo">CLÁUSULA VIGESIMO. – JURISDICCIÓN</div>
        <div class="clausula-contenido">
        ...
        <div class="clausula-titulo">CLÁUSULA VIGESIMO PRIMERO. - DOMICILIO DE LAS PARTES</div>
        <div class="clausula-contenido">
