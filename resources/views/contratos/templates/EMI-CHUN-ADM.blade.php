...
// Función para calcular la duración entre dos fechas (CONTANDO AMBOS DÍAS)
...
<div class="page-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="clausula-contenido">
            En razón de la causa objetiva señalada en la Cláusula Segunda, por el presente documento <strong>LA EMPRESA</strong> contrata a plazo determinado bajo la modalidad de Servicio Específico para que <strong>EL TRABAJADOR</strong> realice las labores de <strong>{{ $trabajador->cargo ?? 'CARGO' }}</strong>, según perfil de puesto. Se deja constancia que <strong>EL TRABAJADOR</strong> cumplirá las labores materia del presente Contrato en el Centro de Operaciones de la Empresa Principal, concretamente en la Unidad Chungar, ubicada en el Distrito de Huayllay, Provincia de Pasco, Departamento de Pasco.
        </div>
...
<div class="page-wrapper">
    ...
    <div class="page-content">
        <div class="clausula-contenido">
            Tratándose de un Contrato de Trabajo sujeto a Modalidad por Servicio Específico, se deja constancia que el presente está sujeto a la temporalidad y contingencias que deriven de la ejecución del "SERVICIO DE OBRAS CIVILES, REMODELACIONES, CARPINTERÍA, MANEJO DE RESIDUOS RELACIONADOS AL MEDIO AMBIENTE Y SERVICIO DE REFORESTACIÓN EN ZONAS CIRCULANTES A LA UNIDAD DE PRODUCCIÓN." CHUNGAR - HUAYLLAY. Para los cuales <strong>LA EMPRESA</strong> fue contratada en virtud al Contrato Principal suscrito con COMPAÑÍA MINERA CHUNGAR SAC., situación que <strong>EL TRABAJADOR</strong> declara conocer plenamente, aceptando a través de la suscripción del presente cualquier cambio que se produzca en la relación contractual entre <strong>LA EMPRESA</strong> y COMPAÑÍA MINERA CHUNGAR SAC (Empresa Principal), y que incida en la relación laboral que por este acto se formaliza entre <strong>LA EMPRESA</strong> y <strong>EL TRABAJADOR</strong>.
        </div>

        <div class="clausula-titulo">CLAUSULA CUARTA. - PLAZO DE VIGENCIA</div>
        <div class="clausula-contenido">
            El inicio del acuerdo contractual es: <strong><?php echo $fechaInicioFormateada; ?></strong>. El plazo de Vigencia del presente contrato entre <strong>EL TRABAJADOR</strong> y <strong>LA EMPRESA</strong> es por el periodo de <strong><?php echo $duracionContrato; ?></strong> del <strong><?php echo $fechaInicioFormateada; ?></strong> al <strong><?php echo $fechaFinFormateada; ?></strong>, en el que concluye la prestación de servicios, sin necesidad de aviso previo entre las partes.
        </div>
...
<div class="clausula-contenido">
    ...
    @endif
        ...
        <div class="clausula-titulo">CLÁUSULA SEPTIMA. - INFORMACIÓN DE LA EMPRESA PRINCIPAL</div>
        <div class="clausula-contenido">
            De conformidad con los Artículos 4° y 6° de la Ley N° 29245, Ley que Regula los Servicios de Tercerización, así como de conformidad con el Artículo 8° del Decreto Supremo N° 006-2008-TR, Reglamento de la Ley que regulan los Servicios de Tercerización, <strong>LA EMPRESA</strong> brindara la información de la Empresa Principal, siempre en cuando <strong>EL TRABAJADOR</strong> lo solicite.
        </div>

        <div class="clausula-titulo">ACTIVIDADES A EJECUTARSE CONFORME AL OBJETO DEL CONTRATO PRINCIPAL</div>
        <div class="clausula-contenido">
            <strong>LA EMPRESA</strong> ha celebrado un Contrato de Tercerización de "SERVICIO DE OBRAS CIVILES, REMODELACIONES, CARPINTERÍA, MANEJO DE RESIDUOS RELACIONADOS AL MEDIO AMBIENTE Y SERVICIO DE REFORESTACIÓN EN ZONAS CIRCULANTES A LA UNIDAD DE PRODUCCIÓN." en adelante denominado Contrato Principal, con la COMPAÑÍA MINERA CHUNGAR SAC., con el objeto de ejecutar los "SERVICIO DE OBRAS CIVILES, REMODELACIONES, CARPINTERÍA, MANEJO DE RESIDUOS RELACIONADOS AL MEDIO AMBIENTE Y SERVICIO DE REFORESTACIÓN EN ZONAS CIRCULANTES A LA UNIDAD DE PRODUCCIÓN." en la Unidad Chungar, de la cual es titular, y que se encuentra ubicada en el Distrito de Huayllay, Provincia Pasco, Departamento Pasco.
        </div>

        <div class="clausula-contenido">
            Conforme a lo establecido en el Contrato Principal, la obra denomina Unidad Chungar es donde se ejecutarán labores de "SERVICIO DE OBRAS CIVILES, REMODELACIONES, CARPINTERÍA, MANEJO DE RESIDUOS RELACIONADOS AL MEDIO AMBIENTE Y SERVICIO DE REFORESTACIÓN EN ZONAS CIRCULANTES A LA UNIDAD DE PRODUCCIÓN." CHUNGAR, servicios contratados con <strong>LA EMPRESA</strong> por COMPAÑÍA MINERA CHUNGAR SAC., se vienen ejecutando y continuarán ejecutándose en el Centro de Operaciones de COMPAÑÍA MINERA CHUNGAR SAC, UEA Chungar, ubicada en el Distrito de Huayllay, Provincia Pasco, Departamento Pasco.
        </div>
...
<div class="page-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="clausula-titulo">CLAUSULA DÉCIMO SEGUNDA. - SOBRE LAS ENFERMEDADES PROFESIONALES</div>
        <div class="clausula-contenido">
...
<div class="page-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="clausula-titulo">CLAUSULA DÉCIMO QUINTA. - PARTICIPACION EN EXAMENES MEDICOS ANUALES</div>
        <div class="clausula-contenido">
        ...
        <div class="clausula-titulo">CLAUSULA DÉCIMO SEXTA. - OCURRENCIA DE ACCIDENTES E INCIDENTES DE TRABAJO</div>
        <div class="clausula-contenido">
...
<div class="page-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="clausula-titulo">CLAUSULA DÉCIMO SEPTIMA. - BUENA FE LABORAL</div>
        <div class="clausula-contenido">
        ...
        <div class="clausula-titulo">CLAUSULA DÉCIMO OCTAVA. - RESERVA, CONFIDENCIALIDAD Y COMPETENCIA</div>
        <div class="clausula-contenido">
...
<div class="page-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="clausula-titulo">CLÁUSULA VIGESIMO PRIMERA. – SUSPENSIÓN DEL CONTRATO</div>
        <div class="clausula-contenido">
            Se deja constancia que la suspensión del presente contrato de trabajo procederá cuando se produzca alguna de las causas previstas en el art. 12° de la LPCL.
        </div>
        
        <div class="clausula-titulo">CLAUSULA VIGESIMO SEGUNDA. - CAUSAS DE EXTINCIÓN</div>
        <div class="clausula-contenido">
        ...
        <div class="clausula-titulo">CLÁUSULA VIGESIMO TERCERA. - CONDICIÓN RESOLUTORIA</div>
        <div class="clausula-contenido">
            Atendiendo a que la causa objetiva que justifica la contratación temporal materia del presente es el cumplimiento de "SERVICIO DE OBRAS CIVILES, REMODELACIONES, CARPINTERÍA, MANEJO DE RESIDUOS RELACIONADOS AL MEDIO AMBIENTE Y SERVICIO DE REFORESTACIÓN EN ZONAS CIRCULANTES A LA UNIDAD DE PRODUCCIÓN." materia del Contrato Principal suscrito entre <strong>LA EMPRESA</strong> y COMPAÑÍA MINERA CHUNGAR SAC. (Empresa Principal), las partes acuerdan que, de conformidad con lo establecido por el art. 16°, inc. c) de la LPCL, el presente Contrato quedará resuelto y se extinguirá por tanto la relación laboral existente entre <strong>LA EMPRESA</strong> y <strong>EL TRABAJADOR</strong>, en caso el Contrato Principal antes reseñado sea resuelto y quede sin efecto, situación que <strong>EL TRABAJADOR</strong> declara conocer con la suscripción del presente.
        </div>

        <div class="clausula-titulo">CLAUSULA VIGESIMO CUARTA. - TERMINO DEL CONTRATO</div>
        <div class="clausula-contenido">
        ...
        <div class="clausula-titulo">CLAUSULA VIGESIMO QUINTA. - PREAVISO EN CASO DE RENUNCIA O RETIRO VOLUNTARIO</div>
        <div class="clausula-contenido">
...
<div class="page-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="clausula-titulo">CLÁUSULA VIGESIMO SEXTA. - NORMAS APLICABLES</div>
        <div class="clausula-contenido">
        ...
        <div class="clausula-titulo">CLAUSULA VIGESIMO SEPTIMA. - DE LA VALIDEZ DEL CONTRATO</div>
        <div class="clausula-contenido">
        ...
        <div class="clausula-titulo">CLÁUSULA VIGESIMO OCTAVA – JURISDICCIÓN</div>
        <div class="clausula-contenido">
        ...
        <div class="clausula-titulo">CLÁUSULA VIGESIMO NOVENA. - DOMICILIO DE LAS PARTES</div>
        <div class="clausula-contenido">
