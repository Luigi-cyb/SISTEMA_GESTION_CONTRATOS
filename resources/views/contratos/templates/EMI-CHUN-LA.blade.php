...
En tal virtud el presente Contrato se celebra de conformidad con los artículos 53°,54°,57 y siguientes del Texto Único Ordenado del Decreto Legislativo N° 728, aprobado por Decreto Supremo N° 003-97-TR, Ley de Productividad y Competitividad Laboral (en adelante) LA LEY.
        ...
        <div class="clausula-contenido">
En razón de la causa objetiva señalada en la Cláusula Segunda, por el presente documento LA EMPRESA contrata a plazo determinado bajo la modalidad de Servicio Específico para que EL TRABAJADOR realice las labores de <strong>"{{ $trabajador->cargo ?? 'CARGO' }}"</strong>, según perfil de puesto. Se deja 
        </div>
...
<div class="page-wrapper">
    ...
    <div class="clausula-contenido">
 constancia que EL TRABAJADOR cumplirá las labores materia del presente Contrato en el Centro de Operaciones de la Empresa Principal, concretamente en la Unidad Chungar, ubicada en el Distrito de Huayllay, Provincia de Pasco, Departamento. de Pasco.
        </div>

        <div class="clausula-contenido">
Tratándose de un Contrato de Trabajo sujeto a Modalidad por Servicio Específico, se deja constancia que el presente está sujeto a la temporalidad y contingencias que deriven de la ejecución del "SERVICIO DE ALQUILER DE EQUIPO DE LÍNEA AMARILLA PARA CODISPOSICIÓN RELAVE – UNIDAD CHUNGAR". Para los cuales LA EMPRESA fue contratada en virtud al Contrato Principal suscrito con COMPAÑÍA MINERA CHUNGAR SAC., situación que EL TRABAJADOR declara conocer plenamente, aceptando a través de la suscripción del presente cualquier cambio que se produzca en la relación contractual entre LA EMPRESA y COMPAÑÍA MINERA CHUNGAR SAC (Empresa Principal), y que incida en la relación laboral que por este acto se formaliza entre LA EMPRESA y EL TRABAJADOR.
        </div>
...
<div class="clausula-contenido">
Atendiendo a que la causa objetiva que justifica la contratación temporal materia del presente es el cumplimiento de "SERVICIO DE ALQUILER DE EQUIPO DE LINEA AMARILLA PARA CODISPOSICION RELAVE – UNIDAD CHUNGAR" materia del Contrato Principal suscrito entre LA EMPRESA y COMPAÑÍA MINERA CHUNGAR SAC. (Empresa Principal), las partes acuerdan que, de conformidad con lo 
        </div>
